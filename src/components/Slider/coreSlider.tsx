...
// import { sanitizeInValue, trimAlignValue, getSizeKey } from './Slider.helpers';
...
//   pageFn?: (...args: unknown[]) => void;
//   onBeforeChange?: (...args: unknown[]) => void;
//   onChange?: (...args: unknown[]) => void;
//   onAfterChange?: (...args: unknown[]) => void;
//   onSliderClick?: (...args: unknown[]) => void;
//   renderTrack?: (...args: unknown[]) => void;
//   renderThumb?: (...args: unknown[]) => void;
//   renderMark?: (...args: unknown[]) => void;
...
// export const ReactSliderFunc: FC<SliderProps> = (props) => {
//   const {
//     min = 0,
//     max = 100,
//     step = 1,
...
//   const [pendingResizeTimeouts, setPendingResizeTimeouts] = useState<ReturnType<typeof setTimeout>[]>([]);
//   const [resizeObserver, setResizeObserver] = useState<Nullable<ResizeObserver>>(null);
//   const [sliderState, setSliderState] = useState<Nullable<SliderState>>(null);
...
//       setPendingResizeTimeouts(pendingResizeTimeouts.slice(1));
//       resize();
//     }, 0);

//     setPendingResizeTimeouts([...pendingResizeTimeouts, resizeTimeout]);
//   }, [pendingResizeTimeouts, resize]);

//   useEffect(() => {
//     let sanitizedValue = sanitizeInValue(value);
//     if (!sanitizedValue.length) {
//       sanitizedValue = sanitizeInValue(defaultValue);
//     }
...
//       setResizeObserver(new ResizeObserver(handleResize));
//       if (resizeObserver && sliderRef?.current) {
//         resizeObserver.observe(sliderRef.current);
//       }
//       resize();
//     }
//   }, [defaultValue, handleResize, props, resize, resizeObserver, value]);
//   return (
//     <div>123</div>
//   );
// };

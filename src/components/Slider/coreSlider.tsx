...
// function pauseEvent(e: SyntheticEvent) {
...
// function prepareOutValue(x: Nullable<any[]>) {
//   if (x === null) {
//     return x;
//   }
...
// // eslint-disable-next-line @typescript-eslint/no-explicit-any
// function trimPreceding(length: number, nextValue: any[], minDistance: number, min: number) {
//   for (let i = 0; i < length; i += 1) {
...
// // eslint-disable-next-line @typescript-eslint/no-explicit-any
// function addHandlers(eventMap: any) {
...
// }
// // eslint-disable-next-line @typescript-eslint/no-explicit-any
// function removeHandlers(eventMap: any) {
//   Object.keys(eventMap).forEach((key) => {
//     if (typeof document !== 'undefined') {
